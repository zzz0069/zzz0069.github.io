...
class AjaxThumbnailRebuild {
	...
	function addAdminMenu() {
		...
		//add_submenu_page('options-framework', 'Rebuild Thumbnails', 'Rebuild Thumbnails', 'ajax-thumbnail-rebuild', 'ajax-thumbnail-rebuild', array(&$this, 'ManagementPage'));
		add_submenu_page('', 'Rebuild Thumbnails', 'Rebuild Thumbnails', 'manage_options', 'ajax-thumbnail-rebuild', array(&$this, 'ManagementPage'));
...
add_action( 'init', create_function( '', 'global $AjaxThumbnailRebuild; $AjaxThumbnailRebuild = new AjaxThumbnailRebuild();' ) );
